    ...
    public function theme()
    {
        if (Request()->isPost()) {
            ...
            if ($config['mojia']['home']['taoke']['state'] == 1) {
                $taoke = $this->moJiaDaTaoKe('https://openapi.dataoke.com/api/goods/list-similer-goods-by-open', array('pageSize' => '50', 'cids' => $config['mojia']['home']['taoke']['type'], 'juHuaSuan' => $config['mojia']['home']['taoke']['qiang'] == 1 ? 1 : '', 'taoQiangGou' => $config['mojia']['home']['taoke']['qiang'] == 2 ? 1 : '', 'tmall' => $config['mojia']['home']['taoke']['qiang'] == 3 ? 1 : '', 'tchaoshi' => $config['mojia']['home']['taoke']['qiang'] == 4 ? 1 : '', 'goldSeller' => $config['mojia']['home']['taoke']['qiang'] == 5 ? 1 : '', 'haitao' => $config['mojia']['home']['taoke']['qiang'] == 6 ? 1 : '', 'specialId' => $config['mojia']['home']['taoke']['brand'], 'sort' => $config['mojia']['home']['taoke']['sort'], 'version' => $config['mojia']['home']['taoke']['ver'], 'appKey' => $config['mojia']['other']['taoke']['key']), $config['mojia']['other']['taoke']['secret']);
                if (!file_put_contents('./application/extra/mojiat.php', '<?php ' . PHP_EOL . 'return ' . var_export(array_slice($taoke['data']['list'], 0, $config['mojia']['home']['taoke']['num']), true) . ';')) {
